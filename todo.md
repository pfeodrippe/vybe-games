...
- [ ] initial support for multiplayer
  ...
  - [ ] handler "no encryption mapping exists" error
  - [ ] private key could be generated by the server
  - [ ] broadcast the position of your player
    ...
    - [ ] mark components as :vg/networked
    - [ ] iterate over the networked components
- [ ] small game for leo
